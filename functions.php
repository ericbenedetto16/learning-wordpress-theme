...
function load_scripts() {
    ...
    wp_enqueue_style( 'main', get_template_directory_uri() . '/assets/css/master.prefixed.min.css', array(), '1.0', 'all' );
    wp_enqueue_style( 'header', get_template_directory_uri() . '/assets/css/header.prefixed.min.css', array(), '1.0', 'all' );
